...
## Delivery & UX Rules
- **In-app toasts** (stacked bottom-right): color-coded (success/info/warning/error), auto-dismiss after 4s (configurable; matches existing toast timing); errors persist with a close button.
